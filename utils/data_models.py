"""
Enhanced Data Models for Audit Workflow
Manages projects, items, coordinators, assignments, comments, and activity logs
"""
...
class AuditItem:
    ...
    def __init__(self, item_id: str, project_id: str, title: str, 
        ...
        self.status = status  # pending, in_progress, submitted, reviewed, completed, returned
        self.created_at = datetime.now().isoformat()
        self.updated_at = datetime.now().isoformat()
...
class ActivityLog:
    ...
    def __init__(self, log_id: str, item_id: str, user: str, 
                 action: str, details: str = '', old_value: str = '', new_value: str = ''):
        self.log_id = log_id
        self.item_id = item_id
        self.user = user
        self.action = action  # status_change, document_submitted, comment_added, etc.
        self.details = details
        self.old_value = old_value  # For status changes
        self.new_value = new_value  # For status changes
...
class AuditDatabase:
    ...
    def get_comments_by_item(self, item_id: str) -> List[Comment]:
        ...
        comments = self.store._load_file(self.comments_file)
        result = [Comment.from_dict(c) for c in comments.values() 
